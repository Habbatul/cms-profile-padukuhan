...
<body class="bg-gray-100 flex flex-col min-h-screen">
            ...
            <div class="flex justify-between">
               ...
               <div id="mobileMenu" class="hidden lg:block absolute lg:relative bottom-0 translate-y-full lg:translate-y-0 left-0 w-full lg:w-fit -z-10 lg:z-20 lg:pr-7 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.4)] lg:shadow-none animate-dissolve-in lg:animate-none">
                    <div class="flex flex-col lg:flex-row space-y-2 lg:space-y-0 pt-8 lg:pt-0 text-center bg-[#026e5a] pb-5 lg:pb-0 lg:transition-opacity">
                        ...
                        <a href="visi-misi" class="text-white underline decoration-4 underline-offset-8 decoration-emerald-400 font-semibold py-1 px-2 rounded-lg  mx-2 font-Inter">Visi-Misi</a>
    ...
    <!-- Isian disini -->
<!-- Isian disini -->
<div class="max-w-screen-xl mx-auto my-auto">
        <div class="max-w-full p-6 flex justify-center items-center">
            <section class="mb-4 mt-4">
                <h2 class="md:text-3xl text-2xl font-bold mb-4 text-center font-Poppins"><span class="text-emerald-700">Visi-Misi</span> Padukuhan</h2>
                <p class="text-justify lg:mx-72 md:mx-8 mx-5">Padukuhan Klangon memiliki visi-misi dalam memajukan padukuhan ini, visi dan misi padukuhan tersebut antara lain yaitu :</p>
            </section>
        </div>
